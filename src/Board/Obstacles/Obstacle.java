...
public abstract class Obstacle {
    ...
    /**
     * getter
     * Checks if the obstacle is destructable
     * (useful for destroying boxes?)
     * @return 
     */
    ...
    /**
     * setter
     * Sets whether obstacle is destructable or not
     * (most likely to be used after bomb explosions and box destruction)
     * @param destructable 
     */
    ...
    /**
     * getter
     * Checks if the obstacle is destructable or not
     * @return 
     */
